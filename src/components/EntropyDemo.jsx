...
export function EntropyDemo() {
  return (
    <div className="flex flex-col items-center justify-center bg-black/40 backdrop-blur-md text-white rounded-3xl overflow-hidden p-8 border border-white/10 my-12">
      <div className="flex flex-col items-center">
        <Entropy className="rounded-lg shadow-2xl border border-white/5" />
